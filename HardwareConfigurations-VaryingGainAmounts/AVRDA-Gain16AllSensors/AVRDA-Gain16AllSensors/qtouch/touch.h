...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(4) | Y(17) | Y(16) | Y(6) | Y(21), Y(23), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_16), FILTER_LEVEL_16    \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(4) | Y(23) | Y(16) | Y(6) | Y(21), Y(17), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_16), FILTER_LEVEL_16    \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(4) | Y(17) | Y(23) | Y(16) | Y(21), Y(6), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_16), FILTER_LEVEL_16    \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(4) | Y(17) | Y(23) | Y(6) | Y(21), Y(16), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_16), FILTER_LEVEL_16    \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(4) | Y(17) | Y(23) | Y(16) | Y(6), Y(21), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_16), FILTER_LEVEL_16    \
	}
...
#define SCROLLER_0_PARAMS                                                                                              \
	{                                                                                                                  \
		SCROLLER_TYPE_SLIDER, 2, 3, SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_5_PERCENT), 8, 20                  \
	}
